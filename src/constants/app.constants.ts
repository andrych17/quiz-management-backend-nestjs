...
export const API_ENDPOINTS = {
  ...
  QUESTION: {
    ...
    UPDATE: (quizId: number | string, questionId: number | string) =>
      `/quizzes/${quizId}/questions/${questionId}`,
    DELETE: (quizId: number | string, questionId: number | string) =>
      `/quizzes/${quizId}/questions/${questionId}`,
    REORDER: (quizId: number | string) =>
  ...
  ATTEMPT: {
    LIST: (quizId?: number | string) =>
      quizId ? `/attempts?quizId=${quizId}` : '/attempts',
  ...
  UPLOAD: {
    ...
    DELETE_QUIZ_IMAGE: (quizId: number | string) =>
      `/upload/quiz/${quizId}/image`,
  },
