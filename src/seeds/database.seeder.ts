  ...
  */
  ...
  private async seedQuizzes(): Promise<void> {
    ...
    const smQuiz = quizRepository.create({
      ...
      isPublished: true,
      startDateTime: new Date('2024-08-01T08:00:00Z'),
      endDateTime: new Date('2025-08-30T23:59:59Z'),
    ...
    const netQuiz = quizRepository.create({
      ...
      isPublished: true,
      startDateTime: new Date('2024-08-15T08:00:00Z'),
      endDateTime: new Date('2025-09-15T23:59:59Z'),
