    ...
    schema: {
      ...
      items: {
        ...
        properties: {
          ...
          servoNumber: { type: 'string', example: 'SRV001', nullable: true },
          quizId: { type: 'number', example: 1 },
          quizTitle: { type: 'string', example: 'Math Quiz' },
          score: { type: 'number', example: 85, nullable: true },
          correctAnswers: { type: 'number', example: 17, nullable: true },
          totalQuestions: { type: 'number', example: 20, nullable: true },
          passingScore: { type: 'number', example: 70, description: 'Nilai minimal untuk lulus (dari quiz)' },
          passed: { type: 'boolean', example: true, nullable: true },
          submissionStatus: { type: 'string', example: 'submitted', enum: ['submitted', 'not_submitted'] },
          passStatus: { type: 'string', example: 'passed', enum: ['passed', 'failed'], nullable: true },
