...
export class CreateQuizScoringDto {
  ...
  @ApiPropertyOptional({
    example: 10,
    description: 'Points awarded for correct answers (default: 10)',
  })
  @IsOptional()
  @IsNumber()
  @Min(0)
  ...
  @ApiPropertyOptional({
    example: 0,
    description: 'Points deducted for incorrect answers (default: 0)',
  })
  @IsOptional()
  @IsNumber()
  @Min(0)
  ...
  @ApiPropertyOptional({
    example: 0,
    description: 'Points deducted for unanswered questions (default: 0)',
  })
  @IsOptional()
  @IsNumber()
  @Min(0)
  ...
  @ApiPropertyOptional({
    example: false,
    description: 'Enable time bonus (default: false)',
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    example: 0.1,
    description: 'Bonus points per second saved (default: 0.0)',
  })
  @IsOptional()
  @IsNumber()
  @Min(0)
  ...
  @ApiPropertyOptional({
    example: true,
    description: 'Whether the scoring template is active (default: true)',
  })
  @IsOptional()
  @IsBoolean()
  isActive?: boolean;
...
export class UpdateQuizScoringDto {
  ...
  @ApiPropertyOptional({
    example: 1,
    description: 'Points deducted for unanswered questions',
  })
  @IsOptional()
  @IsNumber()
  @Min(0)
  ...
  @ApiPropertyOptional({
    example: 0.2,
    description: 'Bonus points per second saved',
  })
  @IsOptional()
  @IsNumber()
  @Min(0)
  ...
  @ApiPropertyOptional({
    example: false,
    description: 'Whether the scoring template is active',
  })
  @IsOptional()
  @IsBoolean()
  isActive?: boolean;
...
export class CalculateScoreDto {
  ...
  @ApiPropertyOptional({
    example: 300,
    description: 'Time spent in seconds (for time bonus calculation)',
  })
  @IsOptional()
  @IsNumber()
  @Min(0)
